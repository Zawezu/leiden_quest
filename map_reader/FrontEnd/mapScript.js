...
// Create circleIcon
circleIcon = L.icon({
    iconUrl: 'FrontEnd/circle_icon.webp',
    iconSize: [32, 32],
    iconAnchor: [16, 16],
    popupAnchor: [16, 16]
});
...
// Create startIcon
startIcon = L.icon({
    iconUrl: 'FrontEnd/start_marker_icon.webp',
    iconSize: [32, 48],
    iconAnchor: [16, 48],
    popupAnchor:  [16, 48]
});
...
// Create endIcon
endIcon = L.icon({
    iconUrl: 'FrontEnd/end_marker_icon.webp',
    iconSize: [32, 48],
    iconAnchor: [16, 48],
    popupAnchor:  [16, 48]
});
...
// Create playerIcon
playerIcon = L.icon({
    iconUrl: 'FrontEnd/player_icon.webp',
    iconSize: [10, 10],
    iconAnchor: [5, 5],
    popupAnchor: [5, 5]
});
...
const markerData = [
    ...
    image: "FrontEnd/images/empanadas.jpeg",
    ...
    title: "X falafel",
    text: "Crispy kip",
    image: "FrontEnd/images/X-Falafel.png",
    },
    {
    coords: [52.16284763059071, 4.484968637263583],
    title: "M Noodle Bar",
    text: "Tasty ramen",
    image: "FrontEnd/images/ramen.jpg.webp",
    ...
    image: "FrontEnd/images/pancakes.jpg",
    ...
    image: "FrontEnd/images/visfontein.jpg",
    },
]
